             ...
             <div class="flex items-center space-x-4">
                 <div class="flex-shrink-0">
                     <img class="w-8 h-8 rounded-full"
                         src="{{ asset('assets/img/users/default-user-profile-picture.jpg') }}" alt="user image">
                 </div>
                 <div class="flex-1 min-w-0">
                     <p class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                         {{ $invitation->data['menage_name'] }}
                     </p>
                     <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                         {{ $invitation->data['from_user_name'] }} -
                         {{ $invitation->data['from_user_email'] }}
                     </p>
                 </div>
                 <div>
